...
class Pacman(GameCharacter):
    ...
    def update(self):
        ...
        # BEGIN CODE CHANGES
        if self.on_left:
            self.maze.eat_dots(self.x, self.y, 'left')
        elif self.on_right:
            self.maze.eat_dots(self.x, self.y, "right")
        elif self.on_top:
            self.maze.eat_dots(self.x, self.y, "top")
        else:
            self.maze.eat_dots(self.x, self.y, "bottom")
        # END CODE CHANGES
